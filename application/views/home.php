...
<html lang="en">
  <head>
    ...
    <!-- Author Meta -->
    <meta name="author" content="Muhammad Alfian Nirkana">
    <!-- Meta Description -->
    <meta name="description" content="Curriculum Vitae Muhammad Alfian Nirkana>
    <!-- Meta Keyword -->
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 text-center">
              <div class="contents">
                ...
                <?php
                $str =  "Saya tertarik dengan CV kamu.";
